...
/// See also:
///
///  * [ModifiedTabBar], which displays a row of tabs.
///  * [TabBarView], which displays a widget for the currently selected tab.
///  * [ModifiedTabBar.indicator], which defines the appearance of the selected tab
...
/// Defines how tabs are aligned horizontally in a [ModifiedTabBar].
///
/// See also:
///
///   * [ModifiedTabBar], which displays a row of tabs.
///   * [TabBarView], which displays a widget for the currently selected tab.
///   * [ModifiedTabBar.tabAlignment], which defines the horizontal alignment of the
///     tabs within the [ModifiedTabBar].
// enum TabAlignment {
...
/// A Material Design [ModifiedTabBar] tab.
///
...
///  * [ModifiedTabBar], which displays a row of tabs.
///  * [TabBarView], which displays a widget for the currently selected tab.
///  * [TabController], which coordinates tab selection between a [ModifiedTabBar] and a [TabBarView].
...
///
/// {@tool dartpad}
/// This sample shows the implementation of [ModifiedTabBar] and [TabBarView] using a [DefaultTabController].
...
///
/// {@tool dartpad}
/// [ModifiedTabBar] can also be implemented by using a [TabController] which provides more options
/// to control the behavior of the [ModifiedTabBar] and [TabBarView]. This can be used instead of
...
///
/// {@tool dartpad}
/// This sample showcases nested Material 3 [ModifiedTabBar]s. It consists of a primary
/// [ModifiedTabBar] with nested a secondary [ModifiedTabBar]. The primary [ModifiedTabBar] uses a
/// [DefaultTabController] while the secondary [ModifiedTabBar] uses a [TabController].
///
...
class ModifiedTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  final void Function(ScrollController) onScrollControllerInit;
  ...
  /// See also:
  ///
  ///  * [ModifiedTabBar], for a primary tab bar.
  ///  * [TabBarView], which displays page views that correspond to each tab.
  ///  * [TabController], which coordinates tab selection between a [ModifiedTabBar] and a [TabBarView].
  ///  * https://m3.material.io/components/tab-bar/overview, the Material 3
  ///     tab bar specification.
  // const ModifiedTabBar.secondary({
  //   super.key,
  //   required this.tabs,
  //   this.controller,
  //   this.isScrollable = false,
  ...
  ///
  /// When [isScrollable] is false, this will yield the same result as if [ModifiedTabBar] was wrapped
  ...
  ///
  /// If [ThemeData.useMaterial3] is true and [ModifiedTabBar] is used to create a
  ...
  /// Specifies the horizontal alignment of the tabs within a [ModifiedTabBar].
  ///
  /// If [ModifiedTabBar.isScrollable] is false, only [TabAlignment.fill] and
  /// [TabAlignment.center] are supported. Otherwise an exception is thrown.
  ///
  /// If [ModifiedTabBar.isScrollable] is true, only [TabAlignment.start], [TabAlignment.startOffset],
  ...
  /// Returns whether the [ModifiedTabBar] contains a tab with both text and icon.
  ///
  /// [ModifiedTabBar] uses this to give uniform padding to all tabs in cases where
  ...
  @override
  State<ModifiedTabBar> createState() => _ModifiedTabBarState();
}
...
class _ModifiedTabBarState extends State<ModifiedTabBar> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.isScrollable) {
      ...
      widget.onScrollControllerInit.call(_scrollController!);
...
/// selected tab.
///
/// This widget is typically used in conjunction with a [ModifiedTabBar].
///
/// {@youtube 560 315 https://www.youtube.com/watch?v=POtoEH-5l40}
///
...
/// [children] list and the length of the [ModifiedTabBar.tabs] list.
///
...
//   /// One widget per tab.
//   ///
//   /// Its length must match the length of the [ModifiedTabBar.tabs]
